class UsersController < ApplicationController
  ...
  authority_actions :new_role => 'update'
  authority_actions :add_role => 'update'
  authority_actions :remove_role => 'update'
  ...
  def create
    ...
    if @user.save
      redirect_to :action => 'show', :id => @user.id, :notice => "New user has been created."
    else
      render :new
    end
  end
  ...
  def add_role
    ...
    app_ids.each do |app_id|
      ...
      @user.add_role params["user"]["role"]["name"].downcase.to_sym, app
    end
